...
struct ConfigData {
    ...
    // uint8_t doorAlarmDelaySec; // 预留扩展: 开门超时报警延时
};
...
enum FuncCode : quint8 {
    ...
    FUNC_CMD_ACK         = 0x80,  // 指令应答(payload:0x00表示成功)
    ...
    // 预留扩展: FUNC_READ_ALL_DATA = 0x00 (上位机主动轮询)

};

// 帧定界符
const char FRAME_HEAD_1 = static_cast<char> (0xAA);
